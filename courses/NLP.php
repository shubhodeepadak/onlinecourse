...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <div class="nlpbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Natural Language Processing</span></h1>
        <h3>Results for Natural Language Processing</h3>
        <hr>
      </div>

      <div id="NATURALLP"></div>
