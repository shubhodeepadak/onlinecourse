...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Courses on Android Development</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="androidbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Courses of Android Development</span></h1>
        <h3>Results for courses of Android Development</h3>
        <hr>
      </div>
