...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Courses on Blockchain</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="blockchainbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Courses on Blockchain Developer</span></h1>
        <h3>Results for courses on Blockchain Developer</h3>
        <hr>
      </div>
