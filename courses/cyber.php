...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Courses on Cyber Security</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="cyberbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Cyber Security Courses</span></h1>
        <h3>Results for Cyber Security courses</h3>
        <hr>
      </div>
