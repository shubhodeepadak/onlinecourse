...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Courses on Data Science</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="datasciencebgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Data Science</span></h1>
        <h3>Results for Data Science</h3>
        <hr>
      </div>

      <div id="DATASCIENCE"></div>
