...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Courses on Deep Learning</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="deeplearningbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Deep Learning</span></h1>
        <h3>Results for Deep Learning</h3>
        <hr>
      </div>

      <div id="DEEPLEARNING"></div>
