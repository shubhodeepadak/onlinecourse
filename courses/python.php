...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Programing in Python</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="pythonbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Programing in Python</span></h1>
        <h3>Results for programing in Python</h3>
        <hr>
      </div>
