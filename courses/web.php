...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Courses on Web Development</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="webbgimage">
      </div>


      <div class="text">
        <h1>Explore <span class="highlight">Courses on Web Development</span></h1>
        <h3>Results for courses on Web Development</h3>
        <hr>
      </div>
