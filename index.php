    ...
    <div class="container">
      ...
      <div class="bgcontainer">
        ...
        <div class="text">
          ...
          <div id="id02" class="modal">
            <form class="modal-content animate" action="" method="post">
              ...
              <div class="containerlog">
                ...
                <button class="logbtn" type="submit" name="login">Login</button>
                </div>
          ...
          <button class="btn3" onclick="document.getElementById('id03').style.display='block'">Sign up</button>
          <div id="id03" class="modal-sign">
            ...
            <form class="modal-content-sign" action="" method="post">
              <div class="container-sign">
                ...
                <p>By creating an account you agree to our <a href="pages/terms.php"  target="_blank" style="color:dodgerblue">Terms of Service and Honor Code</a> and you acknowledge that GetEducated and each Member process your personal data in accordance with the <a href="pages/privacy.php" target="_blank" style="color:dodgerblue">Privacy Policy</a>.</p>
                ...
                <div class="clearfix-sign">
                  ...
                  <button type="submit" class="signupbtn-sign" name="signup">Sign Up</button>
                </div>
              </div>
            </form>
          </div>
      ...
      <div class="instructors">
        ...
        <div class="column">
          <div class="card">
              <img src="images/jose-1.jpg" alt="John Purcell">
              <div class="inside">
      ...
      <div class="objectives">
        ...
        <div class="inside">
          <ul>
            <li>Only Admin will have the complete authority to the information’s about all Instructors and Students.</li>
