    ...
    <div class="container">
      ...
      <div class="text-container">
        ...
        <div class="delete" id="delete">
          ...
          <hr>
          <p>By continuing to delete my account, your account will be permanently deleted. You'll not get any notification or message and not even you'll get any kind of money in the future, if a student buys your course.</p>
          <button type="button" name="delbtn" class="delbtn">Delete</button>
